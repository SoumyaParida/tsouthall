export default {
	testString: 'hello',
	site: {
		title: ' | Michaela Jaritz | Dynamic Speaker, Teacher, Author',
		slogan: {
			title: 'Dynamic Speaker, Teacher, Author',
			line1: 'The mind, once stretched',
			line2: 'by a new idea, never returns',
			line3: 'to its original dimension.',
			line4: 'What lies behind us and what lies before us are tiny matters compared to what lies within us',
			line5: ' - Oliver Wendell Homes',
		},
		description:
			'Training, Coaching und Moderation für Sie persönlich oder für Teams und Gruppen, systemisch, mit der Symbolon-Methode©.',
	},
	pages: {
		willkommen: {
			title: 'About',
			content: {
				...
				fresh: 'Erfrischend.',
				individual: 'What lies behind us and what lies before us are tiny matters compared to what lies within us',
				sustainable: ' - Oliver Wendell Homes',
				subtitle: 'Training. Coaching. Moderation.',
				quote: 'We are Confronted With Insurmountable Opportunities',
				greetings:
					'Are you living to your fullest potential? Are there buried dreams, abandoned goals, untapped potential that you would like to rejuvenate? I Work With People to Motivate and Equip Them to Maximize Their Potential to Be The Best That They Can Be! For information on workshops and key note addresses, or to see how I can help you or your team, please contact me.',
			},
		},
		idee: {
			title: 'Topics',
		...
		'ueber-mich': {
			...
			content: {
				...
				textExperience:
					'25 Jahre Marketing- und Vertriebserfahrung bei der Firma Microsoft Corporation (Redmond, USA) und Microsoft Deutschland GmbH. Sattelfest im Großunternehmen und in der Führung von (virtuellen) Teams. Systemische Trainerin (zertifiziert von der European Coaching Association, ECA) und Symbolon-Spezialistin (akkreditiert von der International Coach Federation, ICF).',
				titleLanguages: 'Sprachverliebt.',
				textLanguages:
					'Als Diplom-Übersetzerin baue ich mit Sprache Brücken: zu Ihnen, zu Ihrem Team, in Ihrer Gruppe. Trainings und Coachings auf Deutsch und Englisch.',
				titleHuman: 'Menschlich.',
				textHuman:
					'Ich begeistere mich für lebenslanges Lernen. Eigenverantwortung und Wertschätzung sind für mich wichtige Werte. Humor, ein pragmatischer Optimismus und eine positive Grundeinstellung zeichnen mich aus.',
			},
		},
		kontakt: {
			title: 'Calendar',
